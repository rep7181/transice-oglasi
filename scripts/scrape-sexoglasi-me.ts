...
const SOURCE = "https://sexoglasi.me/trans";
const IMPORTED_FILE = path.join(__dirname, ".imported-sexoglasi-me.json");
...
const CITY_MAP: Record<string, { country: string; region: string; city: string }> = {
  ...
  "budva": { country: "crna-gora", region: "primorje", city: "budva" },
  "bar": { country: "crna-gora", region: "primorje", city: "bar" },
  "kotor": { country: "crna-gora", region: "primorje", city: "kotor" },
  "herceg novi": { country: "crna-gora", region: "primorje", city: "herceg-novi" },
  "tivat": { country: "crna-gora", region: "primorje", city: "tivat" },
  "ulcinj": { country: "crna-gora", region: "primorje", city: "ulcinj" },
  "nikšić": { country: "crna-gora", region: "sjever", city: "niksic" },
  "niksic": { country: "crna-gora", region: "sjever", city: "niksic" },
  "bijelo polje": { country: "crna-gora", region: "sjever", city: "bijelo-polje" },
  "berane": { country: "crna-gora", region: "sjever", city: "berane" },
  "pljevlja": { country: "crna-gora", region: "sjever", city: "pljevlja" },
  "cetinje": { country: "crna-gora", region: "sjever", city: "cetinje" },
  "danilovgrad": { country: "crna-gora", region: "sjever", city: "danilovgrad" },
};
...
function detectCity(text: string): string {
  ...
  const cities = Object.keys(CITY_MAP).sort((a, b) => b.length - a.length);
...
async function main() {
  ...
  console.log(`[${now}] Scraping sexoglasi.me/trans...`);
  ...
  for (const ad of toImport) {
    try {
      ...
      const loc = findLocation(ad.city) || findLocation("podgorica")!;
